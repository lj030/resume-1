...
\section{工作经验}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
        \resumeItem{高性能实时数仓建设: } {在大规模量数据下(监控领域下日志上报QPS百万级, 吞吐GB/S, 日增量行数千亿级、大小TB级), 标准化监控领域下数仓分层建设, Clickhouse查询耗时P95 7.2s, P99 12s, 计算和存储(Flink、Clickhouse)月成本优化降低10w+}
        \resumeItem{数据质量保障: } {通过技术层面的保障能力建设, 运营层面的治理, 以及流程规范化进行了数据质量的保障, 监控领域下数据延迟P95 min, P99 min, 部门内数据故障复盘年度2例降为0例, 保障支持了春晚等大型活动}
